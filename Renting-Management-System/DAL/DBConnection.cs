...
namespace Renting_Management_System.DAL
{
    class DBConnection
    {
        private string stringConnection = @"Data Source=.\SQLEXPRESS;AttachDbFilename=D:\Project\DataBase\Rent-Management-System.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True";
