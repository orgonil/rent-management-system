...
namespace Renting_Management_System.DAL
{
    class CertificateTypeDAL
    {
        ...
        public DataSet GetAll()
        {
            ...
            ds = da.SelectQuery("Select * from Zhengjianlei");
            return ds;
        }
        /// <summary>
        /// 获取一个证件类
        ...
        public Renting_Management_System.Models.CertificateTypeMod SelectData(string _certificateCode)
        {
            ...
            selectStr.Append("Select * From Zhengjianlei");
        ...
        /// <returns></returns>
        public bool DeleteData(Renting_Management_System.Models.CertificateTypeMod zType)
        {
            type = new Renting_Management_System.Models.CertificateTypeMod();
            type = SelectData(zType.CertificateTypeCode);
            if (type != null)
            {
                da = new DBConnection();
                StringBuilder deleteStr = new StringBuilder();
                deleteStr.Append("Delete From Zhengjianlei");
        ...
        /// <param name="uType"></param>
        /// <returns></returns>
        public bool ModifyData(Renting_Management_System.Models.CertificateTypeMod zType)
        {
            type = new Renting_Management_System.Models.CertificateTypeMod();
            type = SelectData(zType.CertificateTypeCode);
            if (type != null)
            {
                ...
                modifyStr.Append("Update Zhengjianlei");
        ...
        /// <param name="uType"></param>
        /// <returns></returns>
        public bool AddData(Renting_Management_System.Models.CertificateTypeMod zType)
        {
            type = new Renting_Management_System.Models.CertificateTypeMod();
            type = SelectData(zType.CertificateTypeCode);
            if (type == null)
            {
                ...
                insertStr.Append("Insert Into Zhengjianlei (证件类代码,证件类名称)");
